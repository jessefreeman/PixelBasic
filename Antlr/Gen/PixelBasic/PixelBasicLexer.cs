...
public partial class PixelBasicLexer : Lexer {
	...
	public PixelBasicLexer(ICharStream input)
	: this(input, Console.Out, Console.Error) { }

	public PixelBasicLexer(ICharStream input, TextWriter output, TextWriter errorOutput)
